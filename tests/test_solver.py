...
solvers = [
    ...
    solver.BidirectionnalBFSSolver("Bidirectional BFS Solver"),
    solver.AStarSolver(
        utils.half_manhattan_distance, "A* Solver with Manhattan heuristic"
    ),
    solver.MDAStarSolver(name = "A* optimized for Manhattan heuristic"),
    solver.PerimeterAStarSolver(utils.general_half_manhattan_distance, 2, "PA*")
